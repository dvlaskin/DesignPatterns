...
namespace DesignPatterns.Behavioral
{
    ...
    ///
    /// Когда система состоит из множества классов,
    /// объекты которых должны находиться в согласованных состояниях
    ///
    /// Когда общая схема взаимодействия объектов предполагает две стороны:
    /// одна рассылает сообщения и является главным,
    /// другая получает сообщения и реагирует на них.
    /// Отделение логики обеих сторон позволяет их рассматривать независимо
    /// и использовать отдельно друга от друга.
    ///
    /// Когда существует один объект, рассылающий сообщения, и множество подписчиков,
    /// которые получают сообщения. При этом точное число подписчиков заранее неизвестно
    /// и процессе работы программы может изменяться.
    /// 
    /// </summary>
