...
namespace DesignPatterns.Behavioral
{
    ...
    /// При этом замена алгоритма происходит независимо от объекта,
    /// который использует данный алгоритм.
    ///
    /// Когда использовать стратегию?
    /// 
    /// Когда есть несколько родственных классов,
    /// которые отличаются поведением.
    /// Можно задать один основной класс, а разные варианты
    ...
    ///
    /// Когда класс, применяющий определенную функциональность,
    /// ничего не должен знать о ее реализации
    /// </summary>
